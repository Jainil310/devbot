...
if choice == "N" or choice == "n": 
    accessToken = input("Enter your token: ")
else:
   accessToken = "Bearer OTUwMDIxYjUtMWViYy00NzQyLWE1NmMtZjFiM2E3MmZmYWVkYjVhN2U2OWYtOTk0_PC75_47fe537e-27d1-4e32-b2dc-2c26e4aa4fa0"
...
# 6. Provide your MapQuest API consumer key.
        mapsAPIGetParameters = { 
                                "location": location, 
                                "key": "Sgr7vRf1RwMu91omsbM3iyiLHl5F5J4b"
                               }
...
# 10. Provide the Sunrise/Sunset key value for day_length.
        dayLength = "9:33:47"
        hours, minutes, seconds = map(int, dayLength.split(':'))
        dayLengthSeconds = (hours * 3600) + (minutes * 60) + seconds
